...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/HECHEC/Sites/StoNino/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/HECHEC/Sites/StoNino/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once 'D:/HECHEC/Sites/StoNino/app/cache/prod/jms_diextra/doctrine/EntityManager_518def9c7ea7a.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_095e1fcec9d20dcbf779a61e3422517d');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_095e1fcec9d20dcbf779a61e3422517d');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_095e1fcec9d20dcbf779a61e3422517d');
        ...
        $e->setProxyDir('D:/HECHEC/Sites/StoNino/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager518def9c7ea7a_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/HECHEC/Sites/StoNino/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/HECHEC/Sites/StoNino/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/HECHEC/Sites/StoNino/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/HECHEC/Sites/StoNino/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/HECHEC/Sites/StoNino/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/HECHEC/Sites/StoNino/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/HECHEC/Sites/StoNino/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/HECHEC/Sites/StoNino/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/HECHEC/Sites/StoNino/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/HECHEC/Sites/StoNino/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod',
            ...
            'session.save_path' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/HECHEC/Sites/StoNino/app/cache/prod/profiler',
            ...
            'router.resource' => 'D:/HECHEC/Sites/StoNino/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/jms_diextra/doctrine/EntityManager_518def9c7ea7a.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager518def9c7ea7a_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/HECHEC/Sites/StoNino/app/cache/prod/jms_security',
